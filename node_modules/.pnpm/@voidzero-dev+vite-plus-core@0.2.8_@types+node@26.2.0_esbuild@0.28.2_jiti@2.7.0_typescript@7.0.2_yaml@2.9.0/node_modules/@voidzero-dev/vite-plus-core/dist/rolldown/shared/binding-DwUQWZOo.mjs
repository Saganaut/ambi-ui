...
var require_binding = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function requireNative() {
		if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) try {
			...
			try {
				const binding = __require("@voidzero-dev/vite-plus-win32-x64-msvc");
				const bindingPackageVersion = __require("@voidzero-dev/vite-plus-win32-x64-msvc/package.json").version;
				if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			}
			...
			try {
				const binding = __require("@voidzero-dev/vite-plus-win32-arm64-msvc");
				const bindingPackageVersion = __require("@voidzero-dev/vite-plus-win32-arm64-msvc/package.json").version;
				if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			if (process.arch === "x64") {
				...
				try {
					const binding = __require("@voidzero-dev/vite-plus-darwin-x64");
					const bindingPackageVersion = __require("@voidzero-dev/vite-plus-darwin-x64/package.json").version;
					if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
					return binding;
				} catch (e) {
					loadErrors.push(e);
				...
				try {
					const binding = __require("@voidzero-dev/vite-plus-darwin-arm64");
					const bindingPackageVersion = __require("@voidzero-dev/vite-plus-darwin-arm64/package.json").version;
					if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
					return binding;
				} catch (e) {
					loadErrors.push(e);
			...
			try {
				const binding = __require("@voidzero-dev/vite-plus-linux-x64-musl");
				const bindingPackageVersion = __require("@voidzero-dev/vite-plus-linux-x64-musl/package.json").version;
				if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				const binding = __require("@voidzero-dev/vite-plus-linux-x64-gnu");
				const bindingPackageVersion = __require("@voidzero-dev/vite-plus-linux-x64-gnu/package.json").version;
				if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				const binding = __require("@voidzero-dev/vite-plus-linux-arm64-musl");
				const bindingPackageVersion = __require("@voidzero-dev/vite-plus-linux-arm64-musl/package.json").version;
				if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				const binding = __require("@voidzero-dev/vite-plus-linux-arm64-gnu");
				const bindingPackageVersion = __require("@voidzero-dev/vite-plus-linux-arm64-gnu/package.json").version;
				if (bindingPackageVersion !== "0.2.8" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.2.8 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
