import { r as createDebug } from "./main-Jz_9T-KA.js";
import { C as filename_to_dts, S as filename_js_to_dts, T as resolveTemplateFn, _ as RE_JSON, b as RE_TS, g as RE_JS, h as RE_DTS_MAP, m as RE_DTS, p as RE_CSS, v as RE_NODE_MODULES, w as replaceTemplateName, x as filename_dts_to, y as RE_ROLLDOWN_RUNTIME } from "./target-Bab3CUeB-CERZYTwS.js";
import { n as ee, t as at } from "./dist-CMKwGGNp.js";
	...
	return {
		...
		async buildStart(options) {
			if (generator === "tsgo") tsgoContext = await runTsgo(logger, rootDir, tsconfig, sourcemap, tsgo.path);
				...
				tscModule = await import("./tsc-DmzrnJwy.js");
...
function createDtsResolvePlugin({ cwd, tsconfig, tsconfigRaw, resolver, sideEffects, volarContext }) {
	...
	async function resolveDtsPath(id, importer, rolldownResolution) {
		let dtsPath;
		if (resolver === "tsc") {
			const { tscResolve } = await import("./resolver-cwLsPb2o-BqQjnCbF.js");
