...
//#endregion
//#region ../../vite/packages/vite/src/client/bundledDevHmrClient.ts
var BundledDevHMRClient = class extends HMRClient {
	constructor(logger, transport, runtime, options) {
		...
		_defineProperty(this, "applyQueue", Promise.resolve());
		_defineProperty(this, "lastSeq", 0);
		_defineProperty(this, "reloadPending", false);
	}
	isSelfAccepted(id) {
...
//#endregion
//#region ../../vite/packages/vite/src/client/bundledDevClient.ts
