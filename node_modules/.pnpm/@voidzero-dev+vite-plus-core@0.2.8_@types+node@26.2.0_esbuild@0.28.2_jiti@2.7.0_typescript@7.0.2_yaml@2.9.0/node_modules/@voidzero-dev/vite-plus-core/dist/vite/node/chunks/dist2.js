import { mt as __require, pt as __commonJSMin } from "./node.js";
...
var require_stringifyPair = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function stringifyPair({ key, value }, ctx, onComment, onChompKeep) {
		...
		if (keyComment || vsb || vcb) {
			...
			if (hasNewline || !(ctx.inFlow ?? value.flow ?? value.items.length === 0)) {
...
var require_Pair = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Pair = class Pair {
		...
		toJSON(_, ctx) {
			return addPairToJSMap.addPairToJSMap(ctx, ctx?.mapAsMap ? /* @__PURE__ */ new Map() : {}, this);
		}
...
var require_schema$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.schema = [map.map, seq.seq].concat([
		{
			identify: (value) => typeof value === "string",
			default: true,
			tag: "tag:yaml.org,2002:str",
...
var require_stringifyDocument = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function stringifyDocument(doc, options) {
		...
		if (doc.contents) {
			...
			let body = stringify.stringify(doc.contents, ctx, () => contentComment = null, contentComment ? void 0 : () => chompKeep = true);
